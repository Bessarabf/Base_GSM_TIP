...
ifort -c -O2 -assume byterecl -extend-source 80 -O1 -fp-speculation=off -fpe=0 mo_bas_gsm.f90
ifort -c -O2 -assume byterecl -extend-source 80 -O1 -fp-speculation=off -fpe=0 *.for
ifort *.o
