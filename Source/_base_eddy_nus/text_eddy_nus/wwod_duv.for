c    ver     4.03.2021  - NUSINOV far UV model
...
c    
      subroutine wwod_duv(mes,god,day,ut0,utk,dtt,dts,tau,sole,solu,
     *          solet,
...
!
!     analise mas !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      if((mas(4).ne.nse).or.(mas(5)*2.ne.nsu)) then
         print*, ' incorrect nse or nsu ', nse,mas(4),nsu,mas(5)
         stop
      end if
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!  reading sole from danmodel and ... 	
...
! ... writing to fort.10
  ...
  130 continue
      ...
      read(7,929)(solet(i),i=1,nse)
      write(10,777)
      write(10,976)(solet(i),i=1,nse)
     
      m=mas(4)/2
      mr=mas(4)-m*2
      read(7,927)(solen(i),i=1,nse)
      write(10,771)
   ...
   22 continue
      ...
      if(mr.ge.1)nc1=m+1
    6 continue
      write(10,940)(dlw1(k),dlw2(k),solu(k),solu(k+mas(5)),
     *       k=1,mas(5))
...
!! UV & FUV models      
      if(mas(8).ne.0) then
          if (mas(8).eq.1 ) then
     	     call flosu(god,fa0,sole,nse)
	     print*,' flosu'
	    else if (mas(8).eq.2) then
     	      call flosuN(fs,fa0,sole,nse)
	      print*,' flosuN'
          else if (mas(8).eq.3) then
     	      call flosuEUVAC(fs,fa0,sole,nse)
          else
