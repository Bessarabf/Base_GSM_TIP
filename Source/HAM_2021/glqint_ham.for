! version glqint 22/03-2019 add mass partical ionization from HAMMONIA
!
      subroutine glqint_ham(pgl1,par,pari,kpars,nh,its,ids,kdf,ldor,
...
!!! longitude cycle
      do 1 j = 1 , ids
       ...
       END DO
       call ioniz_AEham(sole,solen,rads,par,parj1,gkoor,uts,dtets,dolg,
     *               ddolgs,delta,nh,its,ids,nse,kpars,mass,ps,E0,FAE,j)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! end of longitude 
      key=1
!      open(22,file='parj.dat',form='unformatted')
!      write(22) parj
!      close(22)
!  
      ! pole smoothing
