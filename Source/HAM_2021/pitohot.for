      function pitOhot(alt,co2,cn2,cOhot,ch,che,tOhot,cio,
     *cih,cihe,ti)
      real nuOhot
...
c
      pitn2=b+e+c24*nuOhot(2,ti,tOhot)*ch+c25*che
c
      pitn3=c+f+c34*ch+c35*nuOhot(1,ti,tOhot)*che
      pitOhot=cio*pitn1+cih*pitn2+cihe*pitn3
      return
      end
