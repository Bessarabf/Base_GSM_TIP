C neutral Temperature calculation
...
c
      do 1 i=2,itsm1
       ...
       do 2 j=1,ids
        an60=pgl(7,1,i,j)
        call ijoulp(q,qdj,pgl,pgi,eddyco,rads,g,an60,solu,
...
!
      subroutine ijoulp(q,qdj,pgl,pgi,eddyco,rads,g,an60,solu,
     *                  gkoor,kpars,ins,nh,its,ids,nsu,i,j,uts,
     *                  del,an1,an2,an3,an6,anco2,vr,vi,vj,vim,vid,vir)
      USE mo_gsm_const, ONLY: pi,om
      USE mo_ham_gsm,   ONLY: qdis
