...
!
      subroutine flosuN38(ff,fa0,sole,mas4)
      dimension al(35),bl(35),sole(mas4),bla(3),blr(3),
     *          sol(35),soler(8),ale(8),d(8),solei(8)
      integer godi
...
! 2 first XUV intervals
      sole(1)=solei(1)+solei(2)+solei(3)

      sole(2)=0.
      do i=4,8
        sole(2)=sole(2)+solei(i)
      end do
!
! 35 base Nusinov intervals
!
      sole(3:37)=sol(1:35)
