C                  Subroutines for MSISE - 90 !!!
C     Entry subroutine named CNTN for unification with other versions
C                  ( MSIS-77, MSIS-83, MSIS-86 ).
C
C-----------------------------------------------------------------------
...
C       Calculate spline coefficients
      CALL spline_1(XS,YS,MN,YD1,YD2,Y2OUT)
      X=ZG/ZGDIF
...
C        Density at altitude
   ...
   50 CONTINUE
      ...
      END
C-----------------------------------------------------------------------
      SUBROUTINE spline_1(X,Y,N,YP1,YPN,Y2)
