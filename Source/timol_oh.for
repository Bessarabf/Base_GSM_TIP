      ! variant with hotO
	subroutine timol_OH(pgl1,pgi,kpars,ins,nh,its,ids,dts,vim,vir,vid)
      real vim(nh,its,ids),vid(nh,its,ids),vir(nh,its,ids),nu0,
     *     pgl1(kpars,nh,its,ids),pgi(ins,nh,its,ids)
  ...
  22   format(' error , te=',e10.3,' i=',i4,' ig=',2i4)
          ...
          dvt2=dvt*dvt
          dvf2=dvf*dvf
          a=a0*(pgl1(6,i,ig,j)+pgi(1,i,ig,j))/(pgl1(9,i,ig,j)**1.5)
          sn=pgl1(1,i,ig,j)+pgl1(2,i,ig,j)+0.45*pgl1(3,i,ig,j)
          b=nu0*sn/2.
	      boh=nu0*pgl1(18,i,ig,j)*0.5 ! HOT O
	
          c=c0*sn*(dvr2+dvt2+dvf2)
          r1=dts*(a*pgl1(9,i,ig,j)+b*pgl1(7,i,ig,j)+boh*pgl1(19,i,ig,j)
     *		    +c)
          r2=1.+dts*(a+b+boh)
